...
import Detailsimg from "../images/CareerDetails.jpg";
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-0 shadow rounded bg-white p-4 sticky-bar">
                            <img src={Detailsimg} class="avatar avatar-medium p-4 bg-white shadow-md rounded-pill" alt="" style={{width: "100%"}}/>
                            
                            <div class="mt-4">
                                <h4 class="title mb-3"> Back-End Developer </h4>
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="list-inline-item mb-0 text-primary me-3"><i class="mdi mdi-map-marker text-warning me-2"></i>Beijing, China</li>
                                    <li class="list-inline-item mb-0 text-primary"><i class="mdi mdi-office-building text-warning me-2"></i>Gradle</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                        <div class="sidebar border-0">
                            ...
                            <ul class="list-unstyled mb-0 mt-4">                                
                                <li class="list-inline-item px-3 py-2">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-4">
                                <a href="job_apply.php" class="btn btn-outline-primary">Apply Now <i class="mdi mdi-send"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
